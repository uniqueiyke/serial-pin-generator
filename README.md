...
-The prefix characters of the serial number. This should be alphanumeric characters. 
-If nou provided the serial numbers will be string of numbers only. NOTE: The -`serialNumLength` should be **_four characters_** longer than the length of the `prefixCharacters`. |
