import { randomNumNot0 } from './utils/utility-function';
...
class SerialNumber {
     ...
     */
    constructor(serialNumLength: serialNumLengthInterface, prefixCharacters: string = '', padCount: number) {
    ...
    breakDigits(numOfDigits: number) {
    ...
    generatePrefix(numOfDigits: number = 0) {
        if (!numOfDigits || numOfDigits === 0) return ''
